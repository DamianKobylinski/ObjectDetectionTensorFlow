...
PRETRAINED_MODEL_URL = (
    'http://download.tensorflow.org/models/object_'
    'detection/tf2/20200711/ssd_mobilenet_v2_fpnlite'
    '_320x320_coco17_tpu-8.tar.gz'
)
...
paths = {
    ...
    'CHECKPOINT_PATH': os.path.join('Tensorflow', 'workspace', 'models',
                                    CUSTOM_MODEL_NAME),
    'OUTPUT_PATH': os.path.join('Tensorflow', 'workspace', 'models',
                                CUSTOM_MODEL_NAME, 'export'),
    'TFJS_PATH': os.path.join('Tensorflow', 'workspace', 'models',
                              CUSTOM_MODEL_NAME, 'tfjsexport'),
    'TFLITE_PATH': os.path.join('Tensorflow', 'workspace', 'models',
